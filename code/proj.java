...
// ----------------------- Both DC and Marvel
    ...
    private void deleteIntFrom(String attributeName, int conditionVal){
        try{
            Statement stmt = c.createStatement();
    ...
    private void deleteStringFrom(String attributeName, String conditionVal){
        try{
            Statement stmt = c.createStatement();
            String sql = "DELETE FROM normalIdentity WHERE " + attributeName + "= '" + conditionVal+ "';";
            stmt.execute(sql);
    ...
    public static void main(String args[]){
        ...
        do{
            ...
            if (whatyouwannasee == 3){
                    ...
                    if (whatchawannado == 3){
                        ...
                        if(whattablebuddy3 == 1){
                            ...
                            if (deletenormid == 1){
                                ...
                                sj.deleteIntFrom( attributeName,  conditionVal);
                            ...
                            if (deletenormid == 2){
                                ...
                                sj.deleteStringFrom( attributeName,  conditionVal);
                ...
                System.out.println("Invalid input, use one of the given numbers.");
            }
